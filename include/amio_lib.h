...
//pause function is commented out because there is a conflict with unistd.h when
//compiling for OSX and probably Linux. Use pause function in graphics_lib.h
//instead.
void pause(int time_in_milliseconds); /* a conflict */
